...
CREATE TABLE `Client` (
    ...
    `numContart` VARCHAR(191) NOT NULL,
    `numAssistance` INTEGER NOT NULL,
    `descriptifAssistance` VARCHAR(1000) NOT NULL,
    `nomDomaine` VARCHAR(191) NOT NULL,
    `numSiret` INTEGER NOT NULL,
    `nbreSociete` INTEGER NOT NULL DEFAULT 0,
    `nbreSites` INTEGER NOT NULL DEFAULT 0,
    `nbreAdmins` INTEGER NOT NULL DEFAULT 0,
